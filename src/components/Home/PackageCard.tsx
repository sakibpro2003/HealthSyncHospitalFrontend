...
const PackageCard = () => {
  ...
  return (
    <section className="relative mx-auto mt-20 w-full max-w-6xl px-4 pb-20 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
          {packages.map((single: HealthPackage, index: number) => {
            ...
            return (
              <article
                key={single._id}
                className={`group relative flex h-full flex-col overflow-hidden rounded-3xl border border-white/40 bg-gradient-to-b from-white/90 via-white to-violet-50/60 p-7 shadow-lg ring-1 ring-violet-100/70 backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${
              ...
              >
                ...
                <div className="mt-6 flex items-center gap-3 rounded-2xl bg-gradient-to-r from-violet-700 via-indigo-700 to-sky-600 px-4 py-3 text-white shadow-md ring-1 ring-violet-200/60">
                  <div>
                ...
                <Button
                  ...
                  className={`mt-10 w-full rounded-full py-3 text-sm font-semibold shadow-md transition ${
                    isFeatured
