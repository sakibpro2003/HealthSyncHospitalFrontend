...
const VideoSection: React.FC<VideoSectionProps> = ({
  ...
  return (
    <section className="px-4 py-20 sm:px-6 lg:px-8 mx-auto flex w-full flex-col overflow-hidden rounded-[2.25rem] bg-linear-to-br from-white via-violet-50/70 to-white/60 shadow-2xl ring-1 ring-slate-200/60">
      <div className="relative flex flex-col gap-10 px-6 py-10 md:flex-row md:items-center md:px-12 md:py-14">
        <div
          className="absolute -left-16 top-12 hidden h-36 w-36 rounded-full bg-violet-200/60 blur-3xl md:block"
          aria-hidden
        />
        <div
          className="absolute -right-10 bottom-6 hidden h-48 w-48 rounded-full bg-sky-200/50 blur-3xl md:block"
          aria-hidden
        />
        ...
        <div className="relative z-10 flex-1 space-y-6 text-left">
          ...
          <p className="max-w-xl text-base text-slate-600 sm:text-lg">
            ...
            keeps every patient journey transparent from admission to discharge.
          </p>

          <div className="flex flex-wrap gap-3 text-sm text-slate-600">
            <span className="inline-flex items-center gap-2 rounded-full bg-white px-3 py-2 font-medium shadow-sm">
              <Clock className="size-4 text-violet-500" />4 minute overview
            </span>
            <span className="inline-flex items-center gap-2 rounded-full bg-white px-3 py-2 font-medium shadow-sm">
        ...
        <div className="relative z-10 flex-1">
          <div className="relative mx-auto aspect-video w-full  overflow-hidden rounded-[1.75rem] border border-white/70 shadow-xl">
            <iframe
              className="size-full"
              src={videoUrl}
              ...
              loading="lazy"
            ></iframe>
            <div className="pointer-events-none absolute inset-0 bg-linear-to-t from-slate-900/10 via-transparent to-white/5" />
          </div>
        </div>
      </div>
    </section>
