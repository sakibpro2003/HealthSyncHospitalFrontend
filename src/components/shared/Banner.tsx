...
const Banner = () => {
  ...
  return (
    <section className="relative isolate mx-auto mt-12 w-11/12 overflow-hidden rounded-3xl shadow-2xl">
      <div className="relative flex flex-col gap-10 rounded-[1.75rem] bg-gradient-to-br from-white/95 via-white/85 to-violet-50/80 px-8 py-12 backdrop-blur md:flex-row md:items-center md:px-12">
