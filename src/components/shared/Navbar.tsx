...
const Navbar = () => {
  ...
  return (
    <nav className="w-11/12 mx-auto bg-blue-500  dark:bg-gray-900 sticky top-0 z-50">
          ...
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border md:flex-row md:space-x-8 md:mt-0 md:border-0">
            {routes.map((item) => (
              <li key={item.name}>
                <Link
                  href={item.path}
                  className="block py-2 px-3 rounded-sm text-white hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
                >
                  {item.name}
                </Link>
              </li>
